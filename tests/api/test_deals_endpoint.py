...
def _build_prices_db(path):
    ...
    conn.executemany(
        ...
        [
            ...
            ("RAMI_LEVY", "20", None, "Rami Levy B", "3000", None, "St 1b", 100, None),
            ("RAMI_LEVY", "30", None, "Rami Levy C", "3000", None, "St 1c", 100, None),
            ("SHUFERSAL", "1", None, "Shufersal A", "5000", None, "St 2", 100, None),
            ("OSHER_AD", "5", None, "Osher Ad A", "2000", None, "St 3", 100, None),
        ],
    )
    conn.executemany(
