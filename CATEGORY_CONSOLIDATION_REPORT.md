...
#### 1. פירות וירקות (Produce) - 4 sub-categories, 532 products
- פירות וירקות (284)
- פיצוחים ופירות יבשים (152)
- ירקות ופירות מצוננים (72)
- פירות וירקות אורגניים (24)

#### 2. מוצרים קפואים (Frozen Foods) - 12 sub-categories, 742 products
- גלידות (233)
- מוצרי בשר עוף ודגים קפואים (133)
- ירקות ופירות קפואים (122)
- בצקים ומאפים קפואים (76)
- אוכל מוכן להכנה מהירה (63)
- תחליפי בשר קפוא (55)
- קינוחים ומנות אחרונות (30)
- קפואים לנמנעים מגלוטן (17)
- דגים במעדניה (6)
- תחליפי בשר (4)
- ללא גלוטן (2)
- ירקות מאפים ומונבטים (1)

#### 3. מוצרי חלב וביצים (Dairy & Eggs) - 9 sub-categories, 1,008 products
- גבינות מעדנייה (274)
- מדף הגבינות (253)
- יוגורט ומשקאות יוגורט (157)
- מוצרי חלב וביצים (97)
- מעדנים וקינוחים (71)
- מוצרי אפיה ובישול (63)
- תחליפי חלב וטופו (35)
- תחליפי גבינה פסטרמה שמנת וסלטים (30)
- משקאות ומעדנים תחליפיים (28)

#### 4. בשר, עוף ודגים (Meat, Poultry & Fish) - 8 sub-categories, 568 products
- בשר בקר וכבש (138)
- דגים (121)
- מוצרי עוף והודו (102)
- נקניקים ודגים מעושנים (95)
- מוצרי בשר "על האש" (43)
- מנגלים ומוצרים נילווים (24)
- מוצרים להכנה מהירה (23)
- חומוס וסלטים (22)

#### 5. חומרי בישול (Cooking & Baking Ingredients) - 13 sub-categories, 1,531 products
- שימורים (346)
- פסטה אורז קוסקוס וקטניות (278)
- מוצרי יסוד ותבלינים (224)
- רטבים ותוספות (160)
- מוצרים לאפיה ובישול (120)
- דבש ריבות וממרחים (114)
- מיוחדים (104)
- מרקים קרוטונים ותבשילים (93)
- שמן חומץ ומיץ לימון (52)
- מחיות פרי (28)
- שמן וחומץ (8)
- פסטה אורז וקטניות (3)
- בישול ואפיה (1)

#### 6. לחמים (Bread & Bakery) - 9 sub-categories, 333 products
- לחם, לחמניות ופיתות (129)
- לחמים, לחמניות ופיתות מהמאפיה (87)
- מאפים ועוגות מהמאפיה (87)
- עוגות ארוזות (14)
- אובלטים ומצות (6)
- קרקרים (5)
- מאפים מלוחים ומתוקים (3)
- לחמניות, פיתות ובגטים (1)
- פריכיות (1)

#### 7. חטיפים וממתקים (Snacks & Sweets) - 9 sub-categories, 1,286 products
- ממתקים (416)
- עוגות עוגיות וופלים ארוז (344)
- חטיפים מלוחים (222)
- דגנים וחטיפי דגנים (164)
- פריכיות וקרקרים (100)
- מתוקים (27)
- חטיפים (11)
- חנות הממתקים של עלית (1)
- משקאות (1)

#### 8. משקאות (Beverages & Alcohol) - 8 sub-categories, 1,013 products
- משקאות קלים (326)
- קפה ותה (149)
- יינות משקאות כהליים ותירוש (125)
- בירה ומשקאות אנרגיה (123)
- מים וסודה (97)
- סיגריות וגפרורים (87)
- משקאות חריפים (54)
- קפסולות ופולים לאספרסו (52)

#### 9. ויטמינים (Vitamins & Supplements) - 4 sub-categories, 741 products
- תוספי תזונה (564)
- ויטמינים (149)
- לספורטאים (22)
- תוספי מזון (6)

#### 10. אורגני ובריאות (Organic & Wellness) - 8 sub-categories, 811 products
- מוצרים ללא גלוטן (175)
- מוצרים לבישול ואפיה (145)
- דיאט וללא סוכר (139)
- דגנים, משקאות ומתוקים (113)
- בריאות במקרר (72)
- לחם קרקרים ופריכיות (64)
- מן המקפיא (53)
- פירות וירקות אורגני (50)

### Personal Care & Health Categories

#### 11. שיער וטיפוח גוף (Hair Care & Body Care) - 17 sub-categories, 2,653 products
- טיפוח ועיצוב שיער (767)
- לתינוק - טיפוח, הלבשה ואביזרים (320)
- סבון שמפו ומרכך (316)
- אביזרים לשיער (183)
- הגיינת הפה (180)
- לתינוק - מזון חיתולים ומגבונים (146)
- דאודורנט (135)
- מוצרי הגיינה (112)
- טיפוח גוף ופנים (111)
- גילוח והסרת שיער (79)
...
- איפור ובישום (57)
- מוצרי הגנה מהשמש (45)
- טיפוח ידיים ורגליים (3)
- *14 more sub-categories*

#### 12. טיפוח פנים (Skincare) - 6 sub-categories, 1,597 products
- טיפוח טבעי (816)
- טיפוח פנים (433)
- ניקוי פנים (153)
- עיניים ושפתיים (79)
- שיזוף והגנה מהשמש (59)
- מתנות (57)

#### 13. בישום (Fragrance) - 2 sub-categories, 1,539 products
- מוצרי בישום לנשים (1,086)
- מוצרי בישום לגברים (453)

#### 14. איפור (Makeup) - 4 sub-categories, 980 products
- איפור פנים ואביזרים (364)
- איפור עיניים (310)
- איפור שפתיים (254)
- NYX PM (52)

#### 15. רחצה והגיינה (Bath & Hygiene) - 4 sub-categories, 372 products
- סבון, שמפו ומרכך (261)
- היגיינת פה (73)
- היגיינה (26)
- דאודורנט (12)

#### 16. רוקח ותרופות (Pharmacy & Medical) - 8 sub-categories, 1,056 products
- אופטיקה (325)
- מוצרי בית מרקחת (247)
- אורטופדיה (225)
- מכשור רפואי ואביזרים (163)
- מין והריון (46)
- טיפול בעור (25)
- צינון שיעול וגרון (21)
- מוצרי קורונה (4)

### Family & Pets Categories

#### 17. ילדים ותינוקות (Kids & Babies) - 8 sub-categories, 576 products
- צעצועים ומשחקים (202)
- ארוחת עשר (182)
- אביזרים (81)
- טיפוח התינוק והילד (66)
- הלבשה ואביזרים לתינוקות (31)
- חיתולים ומגבונים (6)
- מזון תינוקות (5)
- ציוד לבית ספר (3)

#### 18. חיות מחמד (Pets) - 3 sub-categories, 177 products
- מוצרים לחתול (101)
- מוצרים לכלב (74)
- דגי נוי, ציפורים ומכרסמים (2)

### Home & Living Categories

#### 19. בית וניקיון (Household & Cleaning) - 11 sub-categories, 998 products
- חד פעמי ונרות (208)
- חומרי ניקוי לבית (176)
- מוצרי כביסה וגיהוץ (167)
- אביזרי ניקיון (114)
- חד פעמי לבישול ואפיה (89)
- מיוחדים בניקיון (70)
- מוצרי נייר (53)
- ניקוי כלים (52)
- שקיות (42)
...
#### 20. מטבח (Kitchen) - 14 sub-categories, 1,608 products
- כלי בישול ואפיה (242)
- ארגון וטקסטיל למטבח (237)
- כלי הגשה ואירוח (222)
- בישול ואפיה (174)
- מוצרים קטנים למטבח (169)
- מיקסרים, בלנדרים ומעבדי מזון (159)
- סכיני מטבח (132)
- מקררים ומדיחי כלים (123)
- קומקומים ומכונות קפה (115)
- פינות אוכל וכסאות (27)
- *4 more sub-categories*

#### 21. חדר שינה (Bedroom) - 5 sub-categories, 585 products
- ארונות ואחסון (230)
- מצעים (162)
- שולחנות, שידות וכסאות (86)
- מיטות, מזרנים ומגני מזרן (64)
- שמיכות וכריות (43)

#### 22. אמבטיה וכביסה (Bathroom & Laundry) - 4 sub-categories, 285 products
- ריהוט ואביזרים לאמבטיה (169)
- מגבות וחלוקים (57)
- אביזרים לשירותים (40)
- אביזרי כביסה וקרשי גיהוץ (19)

#### 23. סלון (Living Room) - 6 sub-categories, 271 products
- כורסאות, הדומים ופופים (87)
- נוי ועיצוב הבית (80)
- ספות ומערכות ישיבה (60)
- מזנונים, כסאות ושולחנות קפה (17)
- עיתונים, מגזינים וחוברות (15)
- שטיחים ווילונות (12)

#### 24. גינה וחוץ (Garden & Outdoor) - 7 sub-categories, 324 products
- ריהוט גן (208)
- גינון והדברה (38)
- נסיעות, קמפינג וים (25)
- בריכות ומשחקי חצר (21)
- תאורה, הצללה ואקססוריז (13)
- אחסון חוץ (11)
- גרילים, מעשנות ואביזרים למנגל (8)

#### 25. טיולים וקמפינג (Travel & Camping) - 8 sub-categories, 328 products
- לקמפינג ולים (226)
- ציוד לגן ולבית ספר (51)
- מזוודות וציוד לנסיעות וטיסות (32)
- קורקינטים, אופניים ואביזרים (7)
- הלבשה והנעלה (5)
- מכשירי כושר (3)
- עיצוב וחיטוב (3)
- *1 more sub-category*

### Technology & Other Categories

#### 26. אלקטרוניקה (Electronics & Appliances) - 20 sub-categories, 1,496 products
- טלוויזיות, אוזניות ואודיו (233)
- מיזוג, מוצרי אקלים (183)
- כביסה, ייבוש וגיהוץ (174)
- סלולר, שעונים, טאבלטים ומצלמות (165)
- שואבי אבק ומכונות שטיפה (126)
- כלי עבודה (112)
- מחשבים וגיימינג (99)
- מוצרי טיפוח אישי (90)
- ציוד היקפי למחשבים (87)
- אביזרי סלולר (58)
- *10 more sub-categories*

#### 27. ביגוד (Clothing) - 61 sub-categories, 163 products
*(Individual clothing items from various brands and types)*
